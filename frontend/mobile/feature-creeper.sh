...
mkdir -p "$FEATURE_DIR/data/data_sources" "$FEATURE_DIR/data/models" "$FEATURE_DIR/data/repository"
mkdir -p "$FEATURE_DIR/domain/entities" "$FEATURE_DIR/domain/repository" "$FEATURE_DIR/domain/usescases"
